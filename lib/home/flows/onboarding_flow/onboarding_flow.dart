...
class OnboardingWelcome extends StatelessWidget {
  ...
  static Page page() => const MyPage<void>(child: OnboardingWelcome());
...
class OnboardingUsage extends StatelessWidget {
  ...
  static Page page() => const MyPage<void>(child: OnboardingUsage());
...
class OnboardingComplete extends StatelessWidget {
  ...
  static Page page() => const MyPage<void>(child: OnboardingComplete());
